...
FetchWebDev() {
  curl -L https://codeload.github.com/Hero-moe/web-dist/tar.gz/refs/heads/dev -o web-dist-dev.tar.gz
...
FetchWebRelease() {
  curl -L https://github.com/alist-org/Hero-moe/releases/latest/download/dist.tar.gz -o dist.tar.gz
